...
void generate(struct generator *gen)
{
    ...
    output_line(out, "#define RESERVATION_AMOUNT 11"); // Zauberzeug issue #7: increase from 10 to 11
    ...
    output_line(out, "    while (n < size)"); // Zauberzeug issue #24: while (n < size || n < 4096) -> while (n < size)
